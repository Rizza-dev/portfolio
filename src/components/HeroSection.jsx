...
const HeroSection = () => {
  return (
    <section className="w-full min-h-[500px] h-screen flex items-center justify-center flex-col md:flex-row relative">
      <Lottie
        className="absolute inset-0 -z-10 rotate-90 scale-150 md:scale-100"
        animationData={animeBackGround}
        loop={true}
      />
      ...
      <a
        href="#about"
        className="w-[32px] h-[48px] absolute bottom-20  border border-slate-400 p-2 rounded-full flex items-center justify-end"
      >
        <motion.span
